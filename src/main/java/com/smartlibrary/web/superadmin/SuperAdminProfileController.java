...
@Controller
@RequestMapping("/superadmin/profile")
public class SuperAdminProfileController {

    private final UserRepository userRepository;
    private final ProfilePhotoService profilePhotoService;

    public SuperAdminProfileController(UserRepository userRepository, ProfilePhotoService profilePhotoService) {
    ...
    public String form(@AuthenticationPrincipal LibraryUserDetails user, Model model) {
        ...
        profileDetails.put("Role", "Super Admin");
        ...
        model.addAttribute("roleLabel", "Super Admin");
    ...
    public String uploadPhoto(
        ...
        return SafeRedirects.toRefererOr(request, "/superadmin/profile");
    }
}
