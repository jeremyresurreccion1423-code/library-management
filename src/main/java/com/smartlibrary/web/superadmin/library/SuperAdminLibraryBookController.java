...
@Controller
@RequestMapping("/superadmin/library/books")
public class SuperAdminLibraryBookController {
    ...
    public SuperAdminLibraryBookController(
    ...
    public String list(
        ...
        return "superadmin/library/books";
    }
    ...
    public String formNew(Model model) {
        ...
        model.addAttribute("authors", authorRepository.findAll());
        model.addAttribute("defaultFinePerDay", libraryProperties.getFinePerDay());
        return "superadmin/library/book-form";
    }
    ...
    public String save(
        ...
        try {
            ...
            return "redirect:/superadmin/library/books";
    ...
    public String uploadEbook(@PathVariable("id") Long id, @RequestParam MultipartFile file, RedirectAttributes ra) {
        ...
        return "redirect:/superadmin/library/books/" + id + "/edit";
    }
}
