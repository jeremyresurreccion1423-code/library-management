...
@Controller
@RequestMapping("/superadmin/library/students")
public class SuperAdminLibraryStudentController {

    private final AdminStudentManagementService adminStudentManagementService;
    private final BookIssueService bookIssueService;
    private final MailNotificationService mailNotificationService;

    public SuperAdminLibraryStudentController(
    ...
    public String search(@RequestParam(required = false) String query, Model model) {
        ...
        return "superadmin/library/student-lookup";
    }
    ...
    public String remindStudent(@PathVariable Long issueId, RedirectAttributes ra) {
        ...
        return "redirect:/superadmin/library/students";
    }

    private String redirectToList(String query) {
        if (query != null && !query.isBlank()) {
            return "redirect:/superadmin/library/students?query="
