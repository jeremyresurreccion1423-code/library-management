...
@Controller
@RequestMapping("/superadmin/library/analytics")
public class SuperAdminLibraryAnalyticsController {
    ...
    public SuperAdminLibraryAnalyticsController(
    ...
    public String analytics(
        ...
        return "superadmin/library/analytics";
    }
    ...
    public String remindStudentFromAnalytics(
        ...
        if (studentId != null && !studentId.isBlank()) {
            return "redirect:/superadmin/library/analytics?studentId=" + studentId;
        }
        return "redirect:/superadmin/library/analytics";
    }
}
