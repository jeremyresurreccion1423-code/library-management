...
public class SuperAdminLibraryIssueController {
    ...
    public SuperAdminLibraryIssueController(
    ...
    public String list(
        ...
        return "superadmin/library/issues";
    }
    ...
    public String issue(@RequestParam Long bookId, @RequestParam String studentId, RedirectAttributes ra) {
        ...
        return "redirect:/superadmin/library/issues";
    }
    ...
    public String reservations(Model model) {
        ...
        return "superadmin/library/reservations";
    }
    ...
    public String issueFromReservation(@PathVariable Long id, RedirectAttributes ra) {
        ...
        return "redirect:/superadmin/library/reservations";
    }
}
